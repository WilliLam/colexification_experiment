...
origdat_baselineutt = do_expmdat_fromfile_csv("csv/uttWeightTestBaseline/t1", 0, "1uttcost_",bogus = c(15), accthreshold = 0.59, edb=resultsfolder)
origdat_baselinenoutt = do_expmdat_fromfile_csv("csv/uttWeightTestBaseline/t2", 0, "0nouttcost_",bogus = c(15), accthreshold = 0.59, edb=resultsfolder)
